...
@Component({
  selector: 'app-single-patient-reports',
  templateUrl: './single-patient-reports.component.html',
  styleUrls: ['./single-patient-reports.component.css']
})
export class SinglePatientReportsComponent implements OnInit {
    ...
    this.ps.profile_Data
      .subscribe(
        data => {
          console.log(data);
          this.list = data;
          console.log('I CANT SEE DATA of reports list : ', this.list);
        }
      );
  }
