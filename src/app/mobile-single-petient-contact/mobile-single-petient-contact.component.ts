...
@Component({
  selector: 'app-mobile-single-petient-contact',
  templateUrl: './mobile-single-petient-contact.component.html',
  styleUrls: ['./mobile-single-petient-contact.component.css']
})
export class MobileSinglePetientContactComponent implements OnInit {
  patients: any;
  user: any;
  list: any;
  id: any;
