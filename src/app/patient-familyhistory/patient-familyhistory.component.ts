...
@Component({
  selector: 'app-patient-familyhistory',
  templateUrl: './patient-familyhistory.component.html',
  styleUrls: ['./patient-familyhistory.component.css']
})
    ...
    this.ps.profile_Data
      .subscribe(
        data => {
          console.log(data);
          this.list = data;
          console.log('I CANT SEE DATA of Patient list : ', this.list);
        }
      );
  }
