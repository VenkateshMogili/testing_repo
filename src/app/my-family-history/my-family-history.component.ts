...
@Component({
  selector: 'app-my-family-history',
  templateUrl: './my-family-history.component.html',
  styleUrls: ['./my-family-history.component.css']
})
export class MyFamilyHistoryComponent implements OnInit {
  patients: any;
  user: any;
  list: any;
  id: any;
