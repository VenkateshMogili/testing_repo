...
@Component({
  selector: 'app-mobile-single-patient-profile',
  templateUrl: './mobile-single-patient-profile.component.html',
  styleUrls: ['./mobile-single-patient-profile.component.css']
})
export class MobileSinglePatientProfileComponent implements OnInit {
