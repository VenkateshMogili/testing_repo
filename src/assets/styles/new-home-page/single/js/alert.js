...
(function ($) {
  $.alert_ext = {
    ...
    // 提示框模版
    tmpl: '<div class="em_alert_pan alert alert-dismissable ${State}"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4 style="white-space: nowrap;">${Title}</h4><p>${Content}</p></div>',
